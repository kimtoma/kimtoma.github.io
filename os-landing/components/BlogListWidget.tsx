...
const RECENT_POSTS: BlogPost[] = [
  { title: "모바일 O/S 별 버전 점유율 확인하기", date: "2023.08", link: "https://kimtoma.com/2023/08/24/mobile-os-usage/" },
  { title: "2022 디자이너가 알아야 할 주요 트렌드", date: "2022.01", link: "https://kimtoma.com/2022/01/06/2022-trends-designers-should-know/" },
  { title: "2021년 회고", date: "2021.12", link: "https://kimtoma.com/2021/12/31/retrospective-2021/" },
  { title: "UI를 여행하는 디자이너를 위한 안내서 - 스위치", date: "2021.09", link: "https://kimtoma.com/2021/09/14/the-designers-guide-to-the-ui-switches/" },
  { title: "UI를 여행하는 디자이너를 위한 안내서 - 버튼", date: "2021.02", link: "https://kimtoma.com/2021/02/10/the-designers-guide-to-the-ui-button/" },
];
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="pt-2 mt-2 border-t border-gray-200">
        <a
          href="https://kimtoma.com/archive"
          target="_blank"
          rel="noopener noreferrer"
